module.exports = function(router) {
  ...
  require('./dev_v3-7.js')(router)
  require('./dev_v3-6.js')(router)
  require('./dev_v3-5.js')(router)
  require('./dev_v3-4.js')(router)
  require('./dev_v3-3.js')(router)
  require('./dev_v3-2.js')(router)
  require('./dev_v3-1.js')(router)
  require('./dev_v3-0.js')(router)
  require('./dev_v2-6.js')(router)
  require('./dev_v2-5.js')(router)
  require('./dev_v2-4.js')(router)
