...
function(e, t) {
  ...
  function i(e) {
      ...
      var t = e.trim();
      return "true" === t || "false" !== t && (0 < t.length && isFinite(t) ? Number(t) : e)
  }
      ...
      function() {
          "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
              value: function _(t) {
                  ...
                  for (var w, b = f.call(arguments, 1), g = function() {
                          if (this instanceof w) {
                              var e = v.apply(this, m.call(b, f.call(arguments)));
                              return o(e) === e ? e : this
                          }
                          return v.apply(t, m.call(b, f.call(arguments)))
...
function(e) {
  ...
  t.prototype.init = function() {
      ...
      "all" === this.$acceptCookiesButton.getAttribute("data-cookie-types") && (this.$module.querySelector(".gem-c-cookie-banner__confirmation-message__accepted").hidden = !1), window.GOVUK.approveAllCookieTypes(), this.$module.showConfirmationMessage(), this.$module.cookieBannerConfirmationMessage.focus(), window.GOVUK.cookie("cookies_preferences_set", "true", {
          days: 365
      ...
      this.$module.querySelector(".gem-c-cookie-banner__confirmation-message__rejected").hidden = !1, this.$module.showConfirmationMessage(), this.$module.cookieBannerConfirmationMessage.focus(), window.GOVUK.cookie("cookies_preferences_set", "true", {
          days: 365
...
function(e) {
  function t(e) {
      this.$module = e, this.$searchToggle = this.$module.querySelector("#super-search-menu-toggle"), this.$searchMenu = this.$module.querySelector("#super-search-menu"), this.$buttons = this.$module.querySelectorAll("button[aria-controls][data-toggle-mobile-group][data-toggle-desktop-group]"), this.hiddenButtons = this.$module.querySelectorAll("button[hidden]")
  }
  var o = {
          label: {
  ...
  var e = function(e, t) {
      ...
      l = {
          ...
          displayURLSurvey: function(e, t) {
              ...
              t.innerHTML = n.render(e), l.setURLSurveyEventHandlers(e)
          },
          displayEmailSurvey: function(e, t) {
              var n = l.getEmailSurveyTemplate();
              t.innerHTML = n.render(e), l.setEmailSurveyEventHandlers(e)
          },
