...
this.Element && function(t) {
  ...
  function(t, e) {
      ...
      (function() {
          ...
          }() || (a = Object.defineProperty, c = Object.prototype.hasOwnProperty("__defineGetter__"), l = "Getters & setters cannot be defined on this javascript engine", u = "A property cannot both have accessors and be writable or have a value", Object.defineProperty = function d(t, e, n) {
              ...
              "DOMTokenList" in this && (!("classList" in (t = document.createElement("x"))) || !t.classList.toggle("x", !1) && !t.className) || ("DOMTokenList" in (e = this) && e.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (e.DOMTokenList = function() {
                  ...
                  return function(i, r) {
                      ...
                      return d(), n(s, "length", function() {
                          ...
                          return d.apply(s, [t]), p !== e ? e ? (s.add(t), !0) : (s.remove(t), !1) : c[t] ? (s.remove(t), !1) : (s.add(t), !0)
                      }, s
                  }
  ...
  function(t) {
      ...
      e.prototype.init = function() {
          ...
          for (var t = [], e = 0, n = this.$graph.querySelectorAll(".mc-tr"), o = 0; o < n.length; o++) {
              ...
              var c = s.length;
              if (c) {
                  this.options.stacked && (s[c - 1].classList.add("mc-stacked-total"), c -= 1);
  ...
  function() {
      ...
      var t = window.GOVUK || {},
          c = function(t, e) {
              this.$element = t, this.$classOverride = void 0 !== e ? e : "gem-c-govspeak__youtube-video"
          };
      c.prototype.init = function() {
          ...
          s.className += this.$classOverride, s.innerHTML = '<span id="' + e + '" data-video-id="' + o + '"></span>', t.title = n.textContent, r.replaceChild(s, i), this.insertVideo(e, t)
  ...
  function(t, e) {
      ...
      function t(t, e) {
              ...
              "Element" in this && "HTMLElement" in this || function() {
                  ...
                  if (!window.Element || window.HTMLElement) {
                      ...
                      var e, n = document.appendChild(document.createElement("body")),
                          ...
                          r = 100;
                      a.attachEvent("onpropertychange", function(t) {
                          for (var e, n = t.propertyName, o = !c.hasOwnProperty(n),
                                  i = a[n], r = c[n], s = -1; e = u[++s];) 1 === e.nodeType && (o || e[n] === r) && (e[n] = i);
                          c[n] = i
                      }), a.constructor = Element, a.hasAttribute || (a.hasAttribute = function s(t) {
                          return null !== this.getAttribute(t)
                      }), t() || (document.onreadystatechange = t, e = setInterval(t, 25)), document.createElement = function d(t) {
          ...
          function() {
          ...
          }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}), c.prototype.t = function(t, e) {
              ...
              return t
          }, c.prototype.replacePlaceholders = function(t, o) {
              var i;
          ...
          }, c.prototype.hasIntlPluralRulesSupport = function() {
              return Boolean(window.Intl && "PluralRules" in window.Intl && Intl.PluralRules.supportedLocalesOf(this.locale).length)
          }, c.prototype.hasIntlNumberFormatSupport = function() {
              return Boolean(window.Intl && "NumberFormat" in window.Intl && Intl.NumberFormat.supportedLocalesOf(this.locale).length)
          }, c.prototype.getPluralSuffix = function(t, e) {
          ...
          }, c.prototype.selectPluralFormUsingFallbackRules = function(t) {
              t = Math.abs(Math.floor(t));
              var e = this.getPluralRulesForLocale();
              return e ? c.pluralRules[e](t) : "other"
          }, c.prototype.getPluralRulesForLocale = function() {
              var t = this.locale,
                  e = t.split("-")[0];
              for (var n in c.pluralRulesMap)
                  if (Object.prototype.hasOwnProperty.call(c.pluralRulesMap, n))
                      for (var o = c.pluralRulesMap[n], i = 0; i < o.length; i++)
                      ...
                      window.Event = Window.prototype.Event = function r(t, e) {
                          ...
                          l._events || (l._events = {}), l._events[n] || (l._events[n] = function(t) {
                              ...
                              for (t.preventDefault = function s() {
                                  ...
                                  }, t.currentTarget = l, t.relatedTarget = t.fromElement || null, t.target = t.target || t.srcElement || l, t.timeStamp = (new Date).getTime(), t.clientX && (t.pageX = t.clientX + document.documentElement.scrollLeft, t.pageY = t.clientY + document.documentElement.scrollTop); ++i < r && !t.cancelImmediate;) i in o && -1 !== u(n, e = o[i]) && "function" == typeof e && e.call(l, t)
              ...
              "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
                  value: function L(e) {
                      ...
                      for (var y, v = h.call(arguments, 1), b = function() {
                          ...
                          }, E = w(0, g.length - v.length), S = [], k = 0; k < E; k++) m.call(S, "$" + k);
                      return y = Function("binder", "return function (" + S.join(",") + "){ return binder.apply(this, arguments); }")(b), g.prototype && (s.prototype = g.prototype, y.prototype = new s, s.prototype = null), y
                  }
              })
          }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {});
      var l = {
      ...
      t.prototype.init = function() {
          ...
          if (h.classList.add(this.upChevronIconClass), d.appendChild(h), p.classList.add(this.sectionShowHideTextClass), d.appendChild(p), r.appendChild(c), r.appendChild(this.getButtonPunctuationEl()), null != i) {
          ...
          var l = e.querySelector("." + this.sectionSummaryClass);
          l && a.push(l.innerText.trim());
          var u = t ? this.i18n.t("hideSectionAriaLabel") : this.i18n.t("showSectionAriaLabel");
          a.push(u), i.setAttribute("aria-label", a.join(" , ")), t ? (r.removeAttribute("hidden"), e.classList.add(this.sectionExpandedClass), n.classList.remove(this.downChevronIconClass)) : (r.setAttribute("hidden", "until-found"), e.classList.remove(this.sectionExpandedClass), n.classList.add(this.downChevronIconClass));
          ...
          this.$showAllButton.setAttribute("aria-expanded", t), this.$showAllText.innerText = e, t ? this.$showAllIcon.classList.remove(this.downChevronIconClass) : this.$showAllIcon.classList.add(this.downChevronIconClass)
      };
      var u = {
  ...
  }), window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {}, window.GOVUK.Modules.GovukAccordion = window.GOVUKFrontend.Accordion,
  function(t) {
      function e(t) {
  ...
  }), window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {}, window.GOVUK.Modules.GovukDetails = window.GOVUKFrontend.Details,
  function(t) {
      function e(t) {
  ...
  }), window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {}, window.GOVUK.Modules.GovukErrorSummary = window.GOVUKFrontend.ErrorSummary, window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {},
  function(t) {
      function e(t) {
          this.$module = t
      }
  ...
  }), window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {}, window.GOVUK.Modules.GovukRadios = window.GOVUKFrontend.Radios, window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {},
  function(t) {
      function e(t) {
  ...
  function(t) {
      function e(t) {
          this.$module = t, this.$module.actions = {}, this.$module.rememberShownStep = !1, this.$module.stepNavSize = !1, this.$module.sessionStoreLink = "govuk-step-nav-active-link",
              this.$module.activeLinkClass = "gem-c-step-nav__list-item--active", this.$module.activeStepClass = "gem-c-step-nav__step--active", this.$module.activeLinkHref = "#content", this.$module.uniqueId = !1
      }
      e.prototype.init = function() {
  ...
  function(t) {
      function e(t) {
          this.$module = t, this._hasResized = !0, this._hasScrolled = !0, this._interval = 50, this.anchorIDs = []
      }
      e.prototype.init = function() {
          window.addEventListener("resize", function() {
              ...
              this._hasScrolled = !0
          }.bind(this)), setInterval(this.checkResize.bind(this), this._interval), setInterval(this.checkScroll.bind(this), this._interval), this.anchors = this.$module.querySelectorAll(".js-page-contents a"), this.getAnchors(), this.checkResize(), this.checkScroll()
      }, e.prototype.checkResize = function() {
          this._hasResized && (this._hasResized = !1, this._hasScrolled = !0)
      }, e.prototype.checkScroll = function() {
          this._hasScrolled && (this._hasScrolled = !1, this.getWindowDimensions().width <= 768 ? this.removeActiveItem() : this.updateActiveNavItem())
          ...
          for (var t = this.getWindowPositions(), e = this.getFooterPosition(), n = 0; n < this.anchors.length; n++) {
              ...
              if (!a) return;
              if (a -= 53, i) var c = this.getNextHeadingPosition(s);
              var l = this.getDistanceBetweenHeadings(a, c);
              (l ? a <= t && t < a + l : a <= t && t < e) && this.setActiveItem(o)
          }
      }, e.prototype.getFooterPosition = function() {
          var t = document.querySelector(".govuk-footer");
          if (t) return this.getElementPosition(t)
          ...
          for (var t = 0; t < this.anchors.length; t++) this.anchors[t].classList.remove("active")
