...
router.use('/', (req, res, next) => {
  req.session.data.version = req.session.data.version || "3-0";
  req.session.data.version_list = req.session.data.version_list || ["3-0", "2-6", "2-5", "2-4", "2-3", "2-2", "2-1", "2-0", "1-42", "1-41", "1-40", "1-39", "1-38", "1-37", "1-36", "1-35", "1-34", "1-33", "1-32", "1-31", "1-30","1-29","1-28","1-27","1-26","1-25","1-24","1-23","1-22","1-21","1-20","1-19","1-18","1-17","1-16","1-15","1-14","1-13","1-12","1-11","1-10","1-9","1-8","1-7","1-6","1-5","1-4","1-3","1-2","1-1","1-0"]
